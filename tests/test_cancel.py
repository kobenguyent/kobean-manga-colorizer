...
def run_cancel_test():
    ...
    create_large_test_pdf(sample_pdf, num_pages=10)
    ...
    print(f"Uploaded 10-page test PDF! Session: {session_id}")
    ...
    # Wait until page 1 or 2 is colorized, then trigger cancel
    time.sleep(0.5)
