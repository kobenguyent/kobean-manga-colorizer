    ...
    MangaPreset(
        ...
        characters=[
            PresetCharacter(
                ...
                costume_hex="#C62828",
                extra_hex="#FFFFFF",
                visual_traits=["red_hair", "buzz_cut", "screentone_hair"],
                notes="Young man with fiery crimson red buzz cut hair, fierce delinquent eyebrows and glare, Shohoku red #10 jersey",
            ),
            PresetCharacter(
                name="Kaede Rukawa",
                hair_hex="#1A1A1A",
                ...
                costume_hex="#C62828",
                extra_hex="#212121",
                visual_traits=["black_hair", "bangs"],
                notes="Handsome boy with jet black hair and straight fringe bangs covering forehead, cool pale skin, Shohoku red #11 jersey",
            ),
            PresetCharacter(
                name="Takenori Akagi",
                hair_hex="#111111",
                ...
                costume_hex="#C62828",
                extra_hex="#FAFAFA",
                visual_traits=["black_hair", "crew_cut", "team_captain"],
                notes="Muscular man with short black flat top crew cut hair, deep tan, Shohoku red #4 jersey, team captain",
            ),
            PresetCharacter(
                name="Haruko Akagi",
                hair_hex="#1A1A1A",
                ...
                costume_hex="#E0E0E0",
                extra_hex="#FFFFFF",
                visual_traits=["black_hair", "bangs", "female"],
                notes="Cute high school girl with big round bright shining eyes and dark fringe bangs, fair skin",
            ),
            PresetCharacter(
                name="Ryota Miyagi",
                hair_hex="#4E3629",
    ...
    MangaPreset(
        ...
        characters=[
            PresetCharacter(
                ...
                extra_hex="#E53935",
                eye_hex="#1565C0",
                visual_traits=["purple_hair", "screentone_hair", "bangs", "ponytail", "little_girl"],
                notes="cute little anime girl robot child with bangs, ponytail or pigtails, round face, headphones or glasses",
            ),
            PresetCharacter(
                ...
                extra_hex="#FFFFFF",
                eye_hex="#212121",
                visual_traits=["black_hair", "mustache", "glasses", "adult_man"],
                notes="adult male scientist inventor with mustache, messy dark hair, expressive comical screaming or panicking face",
            ),
            PresetCharacter(
                name="Gatchan",
                hair_hex="#00E676",
                ...
                extra_hex="#F48FB1",
                eye_hex="#1565C0",
                visual_traits=["green_hair", "baby_angel", "wings"],
                notes="chubby toddler baby angel with bright emerald green hair and small angelic feather wings",
            ),
            PresetCharacter(
                ...
                extra_hex="#FFEB3B",
                eye_hex="#2E7D32",
                visual_traits=["black_hair", "adult_woman", "teacher"],
                notes="tall adult woman school teacher with long dark hair wearing dress",
            ),
            PresetCharacter(
                name="Taro Soramame",
                hair_hex="#424242",
                ...
                extra_hex="#B71C1C",
                eye_hex="#212121",
                visual_traits=["black_hair", "sunglasses", "pompadour", "teenage_boy"],
                notes="teenage delinquent greaser wearing black leather motorcycle jacket and sunglasses",
            ),
        ],
        prompt_guidance=(
